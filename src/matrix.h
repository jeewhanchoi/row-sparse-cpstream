...
/**
 * @brief compute gram matrix by traversing whole entries 
 * whereas mat_form_gram only computes the upper triangular */
...
#define mat_identical splatt_mat_identical
/**
* @brief Allocate a dense matrix and initialize with identical matrix.  
*        Matrix must be freed with mat_free().
*
*
* @param nrows The number of rows in the matrix.
