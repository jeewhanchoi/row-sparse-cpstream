...
# make && ./build/Linux-x86_64/bin/splatt cpd -v --stream=4 -r 16 -t 56 --seed 44 --use_rsp=true --reg=frob,1e-12,1,2,3,4 ~/hpctensor/sm_flickr.tns
#make && ./build/Linux-x86_64/bin/splatt cpd -v --stream=4 -r 16 -t 56 --seed 44 --reg=frob,1e-12,1,2,3,4 ~/hpctensor/sm_flickr.tns
...
make && ./build/Linux-x86_64/bin/splatt cpd -v --stream=4 -r 16 -t 56 --seed 44 --reg=frob,1e-12,1,2,3,4 ~/hpctensor/uber.tns
